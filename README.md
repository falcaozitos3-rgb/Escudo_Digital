...
Desenvolvido com para a Feira de Ciências da Bahia com **inteligência artificial real** e **segurança blindada** contra ciberataques.
...
├──  .env                      #  Não versionar (chaves sensíveis)
│
├──  templates/
...
Desenvolvido com  para a **Feira de Ciências da Bahia 2026**
